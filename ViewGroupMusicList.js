...
class ViewGroupMusicList extends Component {
                    ...
                    >
                        <View style={{width:'70%', height:ScreenUtil.scaleHeight(50), flexDirection:'column',}}>
                            <View style={{width:'100%', height:ScreenUtil.scaleHeight(50), backgroundColor:'lightgray', borderRadius: ScreenUtil.scaleHeight(20), justifyContent:'center', alignItems:'center'}}>
                                <Text style={{color:'black', fontSize: ScreenUtil.scaleHeight(16), lineHeight: ScreenUtil.scaleLineHeight(18)}}>
                                    {this.props.info.groupName+'('+this.state.list.length+')'} 
                                </Text>
                            </View>
                        </View>
                    ...
                    <View style={{width:'100%', height:'100%', flexDirection:'row-reverse'}}>
                        ...
                        <TouchableOpacity style={{height:'100%', width:ScreenUtil.scaleHeight(40), flexDirection:'row', justifyContent:'center', alignItems:'center',}}
                            onPress={() => {
                                ...
                                this.setState({ list: newList });
                                global.groupList.map((group) => {
                                    if (group.groupName === this.props.info.groupName) {
                                        group.list = newList;
                                        DeviceEventEmitter.emit('updateGroupList');
                                    }
                                });
                            }}>
...
export default ViewGroupMusicList;